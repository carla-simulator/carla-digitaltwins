...
void UOpenDriveToMap::GenerateAll(carla::road::Map* ParamCarlaMap,
  FVector MinLocation,
  FVector MaxLocation )
{
...
void UOpenDriveToMap::GenerateRoadMesh( carla::road::Map* ParamCarlaMap, FVector MinLocation, FVector MaxLocation )
{
...
void UOpenDriveToMap::GenerateLaneMarks(carla::road::Map* ParamCarlaMap, FVector MinLocation, FVector MaxLocation )
{
  opg_parameters.vertex_distance = 0.5f;
  opg_parameters.vertex_width_resolution = 8.0f;
...
void UOpenDriveToMap::GenerateSpawnPoints( carla::road::Map* ParamCarlaMap, FVector MinLocation, FVector MaxLocation  )
{
...
void UOpenDriveToMap::GenerateTreePositions( carla::road::Map* ParamCarlaMap, FVector MinLocation, FVector MaxLocation  )
{
  carla::geom::Vector3D CarlaMinLocation(MinLocation.X / 100, MinLocation.Y / 100, MinLocation.Z /100);
  carla::geom::Vector3D CarlaMaxLocation(MaxLocation.X / 100, MaxLocation.Y / 100, MaxLocation.Z /100);
...
float UOpenDriveToMap::DistanceToLaneBorder(carla::road::Map* ParamCarlaMap,
